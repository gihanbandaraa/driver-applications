    ...
    return (
        <View style={{flex: 1, backgroundColor: '#f1f5f9'}}>
            ...
            <View style={{backgroundColor: '#242b4d', paddingTop: 56, paddingBottom: 24, paddingHorizontal: 20}}>
                <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12}}>
                    ...
                    <View style={{flexDirection: 'row', gap: 6}}>
                        {[1,2,3].map(n => (
                            <View key={n} style={{width: n === 1 ? 28 : 8, height: 8, borderRadius: 4, backgroundColor: n === 1 ? 'white' : 'rgba(255,255,255,0.3)'}} />
                        ))}
                    </View>
                    <View style={{width: 40}} />
                </View>
                <Text className="text-white font-JakartaExtraBold text-xl">National ID Card</Text>
                <Text className="text-white/60 font-JakartaMedium text-sm mt-1">Step 1 of 3 â€” Upload a clear photo of both sides</Text>
            </View>
            ...
            >
                ...
                <TouchableOpacity
                    ...
                    style={{
                        ...
                        borderWidth: 2, borderStyle: 'dashed', borderColor: nationalID ? '#242b4d' : '#d1d5db',
                        shadowColor: '#000', shadowOffset: {width: 0, height: 1}, shadowOpacity: 0.04, shadowRadius: 4, elevation: 2,
                        marginBottom: 14,
                    }}
                >
                    {nationalID ? (
                        <Image source={{uri: nationalID}} style={{width: '100%', height: '100%', borderRadius: 18}} resizeMode="contain" />
                    ) : (
                        <View style={{alignItems: 'center'}}>
                            <View style={{width: 64, height: 64, borderRadius: 32, backgroundColor: 'rgba(36,43,77,0.07)', alignItems: 'center', justifyContent: 'center', marginBottom: 12}}>
                                <Ionicons name="card-outline" size={32} color="#242b4d" />
                            </View>
                            <Text className="font-JakartaBold text-gray-700">Tap to upload NIC photo</Text>
                ...
                <TouchableOpacity
                    onPress={() => {
                        if (!nationalID) {
                            Alert.alert('Image Required', 'Please upload a photo of your NIC to continue.');
                            return;
                        }
                        router.push('/(verify)/upload-license');
                    }}
            ...
            <CustomModal
                ...
                content="Ensure the entire card is visible without cropping. Use proper lighting and a plain background for best results."
            />
        </View>
    );
};
